  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`${isSmartMode ? 'hidden' : ''} ${displayMode === 'populated' && !hasPopulatedCopyTargetingFields() ? 'hidden' : ''}`}>
        ...
        <div className={`mb-6 ${displayMode === 'populated' && !isFieldPopulated(formData.industryNiche) ? 'hidden' : ''}`}>
        ...
        <div className={`mb-6 ${displayMode === 'populated' && !isFieldPopulated(formData.targetAudience) ? 'hidden' : ''}`}>
          <div className="flex justify-between items-center mb-1">
        ...
        <div className={`mb-6 ${displayMode === 'populated' && !isFieldPopulated(formData.readerFunnelStage) ? 'hidden' : ''}`}>
          <div className="flex justify-between items-center mb-1">
        ...
        <div className={`mb-6 ${displayMode === 'populated' && !isFieldPopulated(formData.targetAudiencePainPoints) ? 'hidden' : ''}`}>
          <div className="flex justify-between items-center mb-1">
        ...
        {formData.wordCount === 'Custom' && (
          <div className="mb-6">
            <div className="flex justify-between items-center">
              ...
              {!isSmartMode && totalStructureWordCount > 0 && (
                <div className="text-xs text-gray-600 dark:text-gray-400"> {/* Changed from text-yellow-600 */}
                  ...
                  {formData.prioritizeWordCount && totalStructureWordCount !== parseInt(formData.customWordCount?.toString() || '') && (
            ...
            {!isSmartMode && 
             ...
             totalStructureWordCount !== parseInt(formData.customWordCount?.toString() || '') && ( // Changed from bg-yellow-50, text-yellow-800
      ...
      <div className={`${displayMode === 'populated' && !hasPopulatedStrategicMessagingFields() ? 'hidden' : ''}`}>
        ...
        <div className={`mb-6 ${displayMode === 'populated' && !isFieldPopulated(formData.keyMessage) ? 'hidden' : ''}`}>
          <div className="flex justify-between items-center mb-1">
