...
import { calculateTargetWordCount } from '../services/api/utils'; // Import Template type
    ...
    try {
      ...
      if (actionType === 'alternative') {
        ...
        if (formState.generateSeoMetadata) {
          ...
          try {
            const seoMetadata = await generateSeoMetadata(restyledContent, formState, currentUser, addProgressMessage);
            newItem.seoMetadata = seoMetadata;
        ...
        if (formState.generateGeoScore) {
          ...
          try {
            const geoScore = await calculateGeoScore(restyledContent, formState, currentUser, addProgressMessage);
            newItem.geoScore = geoScore;
