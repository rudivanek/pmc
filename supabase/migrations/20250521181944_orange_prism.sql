/*
  # Add brief description to copy sessions and fix token usage table
  
  1. New Tables
    - No new tables created
    
  2. Changes
    - Add brief_description column to pmc_copy_sessions table
    - Fix missing constraints in pmc_user_tokens_usage if it exists
